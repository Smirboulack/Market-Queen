...
App::App(QObject *parent)
    ...
    , m_casting(new Casting(m_settings, m_registry, m_pricing, m_log, this))
    , m_actors(new ActorLibrary(this))
    , m_voiceBooth(new VoiceBooth(m_settings, m_registry, m_pricing, m_log, this))
    , m_director(new Director(m_settings, m_registry, m_pricing, m_casting, m_log, this))
